...
function openModal(member) {
    ...
    if (member === 'moises') {
      ...
      <a href='https://drive.google.com/file/d/1UQ8uFjFUaLOn-iT9ALm8TIFTsnEdC8Tc/view?usp=drive_link' target='_blank'><img src="cv.png"></a></li>
    </ul>
    ...
    `;
      ...
      <h3>Formação Acadêmica</h3>
        ...
        <ul>
          ...
          <a href='https://drive.google.com/file/d/1xi_yP_ggKwB2uOFWhyB-LPX5kC8JX6WF/view?usp=drive_link' target='_blank'><img src="cv.png"></a></li>
        </ul>
    `;
  }
  ...
  if (member === 'raquel') {
    ...
    <h3>Links</h3>
        <ul>
          <li><a href='https://github.com/raquelspedroso' target='_blank'><img src="github.png"></a> 
          <a href='https://www.linkedin.com/in/raquelspedroso/' target='_blank'><img src="linkedin.png"></a> 
          <a href='https://drive.google.com/file/d/18dOmECGHJ_byyZmSEKfrW6YxA97_lEru/view?usp=drive_link' target='_blank'><img src="cv.png"></a></li>
        </ul>
  `;
